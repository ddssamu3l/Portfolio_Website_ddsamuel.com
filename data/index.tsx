export const navItems = [
  ...
  export const gridItems = [
    {
      ...
      description: "",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh] min-h-[45vh]",
    ...
    {
      id: 2,
      title: "I'm flexible with time zone communications and work locations",
      description: "",
    ...
    {
      id: 4,
      title: "SWD, and a Game Designer on the side",
      description: "",
    ...
    {
      id: 5,
      title: "Currently Building a Full Stack E-Commerce Website For My Sister's Jewlery Brand",
  ...
  export const projects = [
    ...
    },
    {
      ...
      des: "A remake Asteroids, featuring self-made particle effects for rocket exhaust and asteroids debris",
