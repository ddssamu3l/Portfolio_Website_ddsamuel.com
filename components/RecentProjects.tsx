  ...
  return (
    <div id = "projects">
      <div className="sm:pt-32 pt-16 flex justify-center">
        <h1 className = "flex flex-col justify-center items-center text-center heading w-4/5" style={{ textShadow: '2px 2px 3px rgba(0, 0, 0, 0.2)'}}>
          Here are some of my {' '}
        ...
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div key={id} className="sm:h-[35rem] h-[28.5rem] lg:min-h[32.5rem] flex items-center justify-center sm:w-[570px] w-[75vw]">
            ...
            <PinContainer title={link} href={link}>
              ...
              <h1 className="mb-2 font-bold lg:text-2xl md:text-xl text-base line-clamp-1" style={{ textShadow: '2px 2px 3px rgba(0, 0, 0, 0.3)' }}>
                {title}
              </h1>

              <p className="lg:text-xl lg:font-normal font-light text-xm line-clamp-2" style={{ textShadow: '1px 1px 3px rgba(0, 0, 0, 0.3)' }}>
                {des}
              </p>
