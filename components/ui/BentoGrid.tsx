    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div
          className={cn(
            titleClassName,
            "group-hover/bento:translate-x-2 transition duration-200 relative h-full min-h-49 flex flex-col px-5 p-5 lg:p-10"
          )}
        >
          ...
          {id === 3 && (
            <img src="/usf.png" alt="usf" className="mt-4 h-24 w-full h-auto" />
          )}
